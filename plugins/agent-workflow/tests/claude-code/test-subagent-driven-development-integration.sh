...
# IMPORTANT: Run from agent-workflow directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"agent-workflow:subagent-driven-development"' "$SESSION_FILE"; then
