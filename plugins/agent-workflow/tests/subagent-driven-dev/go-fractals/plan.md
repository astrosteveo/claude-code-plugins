...
Execute this plan using the `agent-workflow:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/agent-workflow-test/fractals`
