...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/agent-workflow
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/agent-workflow-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using agent-workflow:subagent-driven-development. The plan is at: $PLAN_PATH"
