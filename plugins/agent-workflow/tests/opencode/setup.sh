...
mkdir -p "$HOME/.config/opencode/agent-workflow"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/agent-workflow/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/agent-workflow/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/agent-workflow/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/agent-workflow.js" "$HOME/.config/opencode/agent-workflow/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/agent-workflow/.opencode/plugin/agent-workflow.js" \
       "$HOME/.config/opencode/plugin/agent-workflow.js"
...
echo "Plugin installed to: $HOME/.config/opencode/agent-workflow/.opencode/plugin/agent-workflow.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/agent-workflow.js"
