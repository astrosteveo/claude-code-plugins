...
Complete guide for using Agent Workflow with OpenAI Codex.
...
git clone https://github.com/obra/superpowers.git ~/.codex/agent-workflow
```

#### 2. Install Bootstrap

The bootstrap file is included in the repository at `.codex/agent-workflow-bootstrap.md`. Codex will automatically use it from the cloned location.
...
```
Run ~/.codex/agent-workflow/.codex/agent-workflow-codex find-skills to show available skills
```
...
```
Run ~/.codex/agent-workflow/.codex/agent-workflow-codex find-skills
```

### Loading a Skill

```
Run ~/.codex/agent-workflow/.codex/agent-workflow-codex use-skill agent-workflow:brainstorming
```

### Bootstrap All Skills

```
Run ~/.codex/agent-workflow/.codex/agent-workflow-codex bootstrap
```
...
Personal skills override agent-workflow skills with the same name.

## Architecture

### Codex CLI Tool

**Location:** `~/.codex/agent-workflow/.codex/agent-workflow-codex`
...
**Location:** `~/.codex/agent-workflow/lib/skills-core.js`
...
- `Skill` tool → `~/.codex/agent-workflow/.codex/agent-workflow-codex use-skill`
...
1. Verify installation: `ls ~/.codex/agent-workflow/skills`
2. Check CLI works: `~/.codex/agent-workflow/.codex/agent-workflow-codex find-skills`
3. Verify skills have SKILL.md files

### CLI script not executable

```bash
chmod +x ~/.codex/agent-workflow/.codex/agent-workflow-codex
```
