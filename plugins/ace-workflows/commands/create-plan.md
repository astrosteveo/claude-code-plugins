...
- If research exists (from `/ace-workflows:research-codebase`), READ IT FIRST
...
3. Links to related research (from /ace-workflows:research-codebase)

I'll analyze this information and work with you to create a comprehensive plan.

Tip: Run /ace-workflows:research-codebase first if you need to understand the codebase.
```
...
1. **Read all mentioned files FULLY**:
   - Research documents from `/ace-workflows:research-codebase`
...
**Filename format:** `thoughts/shared/plans/YYYY-MM-DD-description.md`
- YYYY-MM-DD is today's date
- description is a brief kebab-case description
- Example: `2025-01-15-improve-error-handling.md`
...
Ready to iterate with /ace-workflows:iterate-plan or proceed to /ace-workflows:implement-plan.
```
...
- Before planning: `/ace-workflows:research-codebase`
- To update plan: `/ace-workflows:iterate-plan`
- To execute plan: `/ace-workflows:implement-plan`
