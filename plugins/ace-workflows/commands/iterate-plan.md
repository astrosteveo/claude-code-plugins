...
- Plan file path (e.g., `thoughts/shared/plans/2025-01-15-feature.md`)
...
```
User: /ace-workflows:iterate-plan thoughts/shared/plans/2025-01-15-feature.md - add error handling phase
...
```
User: /ace-workflows:iterate-plan thoughts/shared/plans/2025-01-15-feature.md
...
```
User: /ace-workflows:iterate-plan

Agent: Which plan would you like to update?

User: thoughts/shared/plans/2025-01-15-feature.md
...
- Original plan creation: `/ace-workflows:create-plan`
- After iteration: `/ace-workflows:implement-plan`
