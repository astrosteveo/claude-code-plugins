---
description: "Update implementation plans without thoughts directory (codebase-only research)"
...
## Difference from Standard iterate-plan

This variant:
- Only spawns codebase research agents when research is needed
- Skips thoughts-locator and thoughts-analyzer agents entirely
- Does not reference files in thoughts/shared/
- Use this for projects that don't have a thoughts/ directory structure

## Initial Response

**Parse input to identify:**
- Plan file path (e.g., `plans/2025-01-15-feature.md`)
...
### Step 2: Research If Needed (Codebase Only)
...
2. Spawn parallel codebase sub-agents:
...
- Verify technical feasibility with codebase research
...
```
User: /ace-workflows:iterate-plan-nt plans/2025-01-15-feature.md - add error handling phase

Agent: [Reads plan, researches error patterns, updates plan]

I've added a new Phase 3 for error handling...
```

**Scenario 2: User provides just plan file**

```
User: /ace-workflows:iterate-plan-nt plans/2025-01-15-feature.md

Agent: I've found the plan. What changes would you like to make?

User: Split Phase 2 into backend and frontend phases

Agent: [Confirms understanding, makes changes]
```

**Scenario 3: User provides no arguments**

```
User: /ace-workflows:iterate-plan-nt

Agent: Which plan would you like to update?

User: plans/2025-01-15-feature.md

Agent: What changes would you like to make?

User: Add performance tests to success criteria
...
- Original plan creation: `/ace-workflows:create-plan-nt`
- For codebase research: `/ace-workflows:research-codebase-nt`
- Standard version (with thoughts): `/ace-workflows:iterate-plan`
